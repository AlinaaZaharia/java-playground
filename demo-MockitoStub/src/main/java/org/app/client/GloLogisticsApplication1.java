...
public class GloLogisticsApplication1 {
    public static void main(String[] args) {
        // TODO Auto-generated method stub
        ShipmentOrderService shipmentOrderService = new ShipmentOrderServiceImpl();
        ...
        while (true) {
            ...
            System.out.println("6. Get Estimated Delivery Time");
            ...
            switch (choice) {
                case 1:
                    ...
                    ShipmentOrder newOrder = new ShipmentOrder(orderId, origin, destination, weight,status);
                ...
                case 2:
                    ...
                    ShipmentOrder foundOrder = shipmentOrderService.getShipmentOrder(searchOrderId);
                    if (foundOrder != null) {
                ...
                case 3:
                    List allOrders =
                            shipmentOrderService.getAllShipmentOrders();
                ...
                case 4:
                    ...
                    ShipmentOrder existingOrder = shipmentOrderService.getShipmentOrder(updateOrderId);
                ...
                case 6:
                    ...
                    String estimatedDeliveryTime=shipmentOrderService.getEstimatedDeliveryTime(trackingNo);
