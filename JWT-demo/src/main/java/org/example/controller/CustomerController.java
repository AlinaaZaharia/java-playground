...
public class CustomerController {
    ...
    @PutMapping("{id}")
    public ResponseEntity<CustomerDto> updateCustomerById(@PathVariable(value = "id") long id, @Valid @RequestBody CustomerDto customerDto){
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<DeleteResponse> removeCustomer(@PathVariable(value = "id") long id){
